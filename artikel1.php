      ...
      <div class="row">
        ...
        <div class="col-9 p-0 d-flex flex-column">
          ...
          <div class="konten flex-grow-1 p-4">
            <div class="artikel-judul">Indomie Seleraku</div>
            <div class="artikel-tanggal">
              Ditulis pada 22 Juli 2025 oleh Admin
            </div>
            <div class="artikel-konten">
              <p>
                Indomie adalah mie instan legendaris yang telah menjadi favorit
                di banyak rumah tangga di Indonesia dan mancanegara. Rasa yang
                kaya dan beragam menjadikan Indomie pilihan utama masyarakat
                dari berbagai usia.
              </p>
              <p>
                Artikel ini akan membahas bagaimana Indomie menjadi bagian dari
                gaya hidup, bukan hanya sebagai makanan cepat saji, tapi juga
                sebagai budaya yang menyatukan banyak orang. Mulai dari anak kos
                hingga pekerja kantoran, semua pasti pernah merasakan nikmatnya
                Indomie.
              </p>
              <p>
                Tidak hanya itu, inovasi Indomie dalam menghadirkan berbagai
                varian rasa juga menjadi alasan utama mengapa brand ini tetap
                eksis hingga kini.
              </p>
            </div>
          </div>

          <footer class="text-end px-3 pb-3">
