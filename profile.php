      ...
      <div class="row">
        ...
        <div class="col-9 p-0 d-flex flex-column">
          ...
          <div class="border-bottom">
            <ul class="nav">
              <li class="nav-item">
                <a class="nav-link active" href="profile.php"><u>Profile</u></a>
              </li>
              <li class="nav-item">
          ...
          <div class="konten flex-grow-1 p-4">
            ...
            <p>
              Indomie merupakan salah satu merek mie instan terpopuler di
              Indonesia yang telah berdiri sejak tahun 1972. Produk ini
              diproduksi oleh PT Indofood CBP Sukses Makmur Tbk dan telah
              menjadi bagian penting dari keseharian masyarakat Indonesia.
            </p>
            <p>
              Dengan cita rasa khas nusantara dan beragam varian rasa, Indomie
              tidak hanya digemari di dalam negeri, tetapi juga diekspor ke
