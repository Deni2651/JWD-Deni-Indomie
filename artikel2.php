      ...
      <div class="row">
        ...
        <div class="col-9 p-0 d-flex flex-column">
          ...
          <div class="konten flex-grow-1 p-4">
            <div class="artikel-judul">Indomie Bikin Sehat</div>
            <div class="artikel-tanggal">
              Ditulis pada 22 Juli 2025 oleh Admin
            </div>
            <div class="artikel-konten">
              <p>
                Dengan kandungan karbohidrat dan vitamin dari bumbu pelengkap,
                Indomie dapat menjadi sumber energi.
              </p>
              <p>
                Tentunya tetap sebaiknya dikonsumsi secara seimbang dan
                dilengkapi dengan sayuran dan protein lainnya.
              </p>
            </div>
          </div>
