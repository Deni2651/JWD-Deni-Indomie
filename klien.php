      ...
      <div class="row">
        ...
        <div class="col-9 p-0 d-flex flex-column">
          ...
          <div class="konten flex-grow-1 p-4">
            <h2>Foto Klien</h2>
            <p>Dokumentasi bersama konsumen dan pelanggan setia kami:</p>

            <div class="row row-cols-1 row-cols-md-3 g-3">
              <div class="col">
                <img
                  src="/images/klien.png"
                  class="img-fluid rounded"
                  alt="Klien 1"
                  class="img-fluid" style="max-width: 200px;"
                />
                <p class="text-center">Pelanggan di booth Indomie</p>
              </div>
              <div class="col">
                <img
                  src="/images/klien.png"
                  ...
                  class="img-fluid" style="max-width: 200px;"
                />
                <p class="text-center">Komunitas pecinta Indomie</p>
              </div>
              <div class="col">
                <img
                  src="/images/klien.png"
                  ...
                  class="img-fluid" style="max-width: 200px;"
                />
                <p class="text-center">Pemenang lomba Indomie</p>
              </div>
            </div>
          </div>
