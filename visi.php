        ...
        <div class="col-9 p-0 d-flex flex-column">
          ...
          <div class="border-bottom">
            <ul class="nav">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="visi.php"><u>Visi dan Misi</u></a>
              </li>
              <li class="nav-item">
          ...
          <div class="konten flex-grow-1 p-4">
            <h2>Visi</h2>
            <p>
              Menjadi merek mie instan terdepan yang mendunia, menghadirkan cita
              rasa khas Indonesia dengan kualitas terbaik.
            </p>

            <h2 class="mt-4">Misi</h2>
            <ul>
              <li>
                Menyediakan produk mie instan yang lezat, aman, dan berkualitas
                tinggi.
              </li>
              <li>
                Terus berinovasi dalam menciptakan varian rasa yang sesuai
                dengan selera masyarakat global.
              </li>
              <li>
                Mendukung kesejahteraan masyarakat melalui program tanggung
                jawab sosial perusahaan.
              </li>
              <li>
                Mengutamakan keberlanjutan lingkungan dalam setiap proses
                produksi.
              </li>
            </ul>
          </div>
