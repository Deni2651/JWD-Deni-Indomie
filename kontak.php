        ...
        <div class="col-9 p-0 d-flex flex-column">
          ...
          <div class="border-bottom">
            <ul class="nav">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="kontak.php"><u>Kontak</u></a>
              </li>
              <li class="nav-item">
          ...
          <div class="konten flex-grow-1 p-4">
            ...
            <ul class="list-unstyled">
              <li>
                <strong>Alamat:</strong> Jl. Indomie No. 1, Jakarta, Indonesia
              </li>
              <li><strong>Telepon:</strong> (021) 12345678</li>
              <li><strong>Email:</strong> info@indomie.co.id</li>
              <li><strong>Instagram:</strong> @indomie</li>
              <li><strong>Facebook:</strong> Indomie Indonesia</li>
            </ul>
