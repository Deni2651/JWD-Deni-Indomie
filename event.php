      ...
      <div class="row">
        ...
        <div class="col-9 p-0 d-flex flex-column">
          ...
          <div class="konten flex-grow-1 p-4">
            <h2>Event Gallery</h2>
            <p>Beberapa dokumentasi kegiatan promosi dan acara kami:</p>
            ...
            <div class="row row-cols-1 row-cols-md-3 g-3">
              <div class="col">
                <img
                  ...
                  alt="Event 1"
                />
                <p class="text-center">Festival Rasa Nusantara</p>
              </div>
              <div class="col">
                <img
                  ...
                  alt="Event 2"
                />
                <p class="text-center">Booth Indomie di Expo Makanan</p>
              </div>
              <div class="col">
                <img
                  ...
                  alt="Event 3"
                />
                <p class="text-center">Lomba Masak Indomie</p>
              </div>
            </div>
          </div>
